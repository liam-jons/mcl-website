              ...
              <Card className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800">
                <CardBody>
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Neurodiversity Understanding</h3>
                    <p className="text-gray-600 dark:text-gray-300">
                    We know what it takes to enable someone to thrive.
                    </p>
                  </div>
                </CardBody>
              </Card>
